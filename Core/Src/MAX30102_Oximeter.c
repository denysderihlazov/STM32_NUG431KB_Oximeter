...
OXIMETER_Status MAX30102_CheckConnection()
{
	...
	uint8_t part_id = 0;
	if(HAL_I2C_Mem_Read(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0xFF, I2C_MEMADD_SIZE_8BIT, &part_id, 1, HAL_MAX_DELAY))
	{
...
OXIMETER_Status MAX30102_LEDConfig()
{
	  ...
	  if(HAL_I2C_Mem_Write(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0x0C, I2C_MEMADD_SIZE_8BIT, &led1_pa, 1, HAL_MAX_DELAY) != HAL_OK)
	  {
		  return OXIMETER_ERROR;
	  }


	  if(HAL_I2C_Mem_Write(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0x0D, I2C_MEMADD_SIZE_8BIT, &led2_pa, 1, HAL_MAX_DELAY) != HAL_OK)
	  {
		  return OXIMETER_ERROR;
	  }
...
OXIMETER_Status MAX30102_SetSpO2Mode()
{
	  ...
	  if(HAL_I2C_Mem_Write(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0x09, I2C_MEMADD_SIZE_8BIT, &mode_config, 1, HAL_MAX_DELAY) != HAL_OK)
	  {
		  return OXIMETER_ERROR;
	  }
	  ...
	  if(HAL_I2C_Mem_Write(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0x0A, I2C_MEMADD_SIZE_8BIT, &spo2_config, 1, HAL_MAX_DELAY) != HAL_OK)
	  {
		  return OXIMETER_ERROR;
	  }
...
OXIMETER_Status MAX30102_SlotCofig()
{
	  ...
	  if(HAL_I2C_Mem_Write(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0x11, I2C_MEMADD_SIZE_8BIT, &slot_config, 1, HAL_MAX_DELAY) != HAL_OK)
	  {
...
OXIMETER_Status MAX30102_ResetFIFOPointers()
{
	  ...
	  if(HAL_I2C_Mem_Write(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0x04, I2C_MEMADD_SIZE_8BIT, &fifo_config, 1, HAL_MAX_DELAY) != HAL_OK)
	  {
		  return OXIMETER_ERROR; // FIFO Write Pointer ERROR
	  }

	  if(HAL_I2C_Mem_Write(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0x05, I2C_MEMADD_SIZE_8BIT, &fifo_config, 1, HAL_MAX_DELAY) != HAL_OK)
	  {
		  return OXIMETER_ERROR; // FIFO Overflow Counter ERROR
	  }

	  if(HAL_I2C_Mem_Write(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0x06, I2C_MEMADD_SIZE_8BIT, &fifo_config, 1, HAL_MAX_DELAY) != HAL_OK)
	  {
...
OXIMETER_Status MAX30102_DataCollectTurnOn()
{
	  ...
	  if(HAL_I2C_Mem_Write(&hi2c1, MAX30102_I2C_ADDRESS << 1, 0x20, I2C_MEMADD_SIZE_8BIT, (uint8_t*)&start_collect, 2, HAL_MAX_DELAY) != HAL_OK)
	  {
